                ...
                <nav className="navbar navbar-expand-sm navbar-dark">
                    ...
                    <div className="collapse navbar-collapse" id="collapsibleNavbar">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" href="/gestaoutilizadores">Utilizadores</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="/dashboardclientes">Clientes</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="/dashboardfornecedores">Fornecedores</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="/dashboardprodutos">Produtos</a>
                            </li>
                        </ul>
                    </div>
                    <form className="form-inline" action="/pesquisa" method="get">
                        <input type="text" className="form-control" style={{ height:'40px', width:'80%' }} placeholder="Pesquisar"/>
                        &nbsp;
                    ...
                    <div className="dropdown show">
                        <button type="button" className="btn dropdown-toggle" data-toggle="dropdown">
                            <img src="images/foto1.png" style= {{ width:'40px', height:'40px', borderRadius:'5px'}}/>
                        </button>
