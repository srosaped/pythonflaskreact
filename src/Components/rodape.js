            ...
            <div>
                <div className="container-fluid bg-dark">
                    <div className="container">
                        <div className="row">
                            <div className="col-3 text-white mt-4 mb-4">
                                <h4 className="display-4" style={{fontSize:'25px'}}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-geo" viewBox="0 0 16 16">
                                ...
                                <div className="container">
                                    <ul className="nav flex-column">
                                        <li className="nav-item">
                                            <a className="nav-link text-white" href="/dashboardprincipal">Início</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link text-white" href="/quemsomos">Quem somos</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link text-white" href="/montraprodutos">Produtos</a>
                                        </li>
                                        <li className="nav-item">
                            ...
                            <div className="col-3 text-white mt-4">
                                ...
                                <div style={{width:'45%',textAlign:'center'}}>
                                    Seg. a Sex.<br/>09:00 às 13:00<br/>e<br/>14:00 às 18:00
                                </div>
                            </div>
                            <div className="col-3 text-white mt-4">
                                <h4 className="display-4" style={{fontSize:'25px',marginBottom:'30px'}}>
                                ...
                                <form>
                                    <div className="input-group input-group-lg">
                                        <input type="email" className="form-control" id="emailnewsletter" name="emailnewsletter" placeholder="o seu e-mail"></input>
                            ...
                            <div className="col-3 text-white mt-4">
                                <h4 className="display-4" style={{fontSize:'25px'}}>
                                    ...
                                    Redes sociais<br/><br/>
                                    <a className="btn btn-light text-dark pt-2 pl-2 mr-1" href="#" style={{width:'45px',height:'45px'}}>
                ...
                <div className="container-fluid" style={{backgroundColor:'black', color:'white', textAlign:'center'}}>
                    &copy; 2021 - WHITENOTE Todos os direitos reservados
                </div>
            </div>
        );
    };
